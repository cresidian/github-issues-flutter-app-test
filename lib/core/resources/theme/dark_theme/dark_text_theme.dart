...
class TextThemeDark implements AppTextTheme {
  @override
  ...
  TextThemeDark(this.primaryColor) {
    data = TextTheme(
      ...
      displaySmall: TextStyle(
          fontSize: 36, fontWeight: FontWeight.w400, color: primaryColor),
      headlineLarge: TextStyle(
          fontSize: 32, fontWeight: FontWeight.w400, color: primaryColor),
      headlineMedium: TextStyle(
          fontSize: 28, fontWeight: FontWeight.w500, color: primaryColor),
